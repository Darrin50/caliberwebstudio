    ...
    <section id="contact" className="section-dark" aria-labelledby="contact-heading">
      <div className="container-main">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto">
          ...
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-teal/20 group-hover:bg-teal/30 transition-colors">
              <svg className="h-7 w-7 text-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-white/5 p-8 text-center sm:col-span-2 lg:col-span-1">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-teal/20">
              <svg className="h-7 w-7 text-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
