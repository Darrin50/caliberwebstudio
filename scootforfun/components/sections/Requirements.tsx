        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex gap-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-navy/8">
            <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-teal/10">
              <svg className="h-6 w-6 text-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="flex gap-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-navy/8">
            <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-purple-50">
              <svg className="h-6 w-6 text-purple-brand" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
