  ...
  return {
    ...
    openGraph: {
      ...
      images: post.thumbnail
        ? [{ url: post.thumbnail, alt: post.title, width: 1200, height: 630 }]
        : [{ url: "/logo-full-hero.png", alt: post.title, width: 1200, height: 630 }],
    },
  };
}
...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: post.category, item: `https://caliberwebstudio.com/blog/${post.slug}` },
    ],
  };
