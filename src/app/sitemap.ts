...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/services/ai-chatbot`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/services/review-automation`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${baseUrl}/pricing`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/startup-complete`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${baseUrl}/guarantee`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
