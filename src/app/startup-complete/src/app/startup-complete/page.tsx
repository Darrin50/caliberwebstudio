...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'We\'ll turn your idea into a running business in 48 hours. Everything you need — built, deployed, and ready to take customers.',
...
const serviceSchema = {
  ...
  description: 'A premium done-for-you service that transforms your business idea into a fully operational company in 48 hours.',
    ...
    <>
      ...
      <main style={{ paddingTop: '72px', background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <section id="whats-included" style={{ padding: 'clamp(60px, 8vw, 100px) clamp(20px, 6vw, 80px)', maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <h2 className="fu" style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 'clamp(1.75rem, 4vw, 2.75rem)', color: 'var(--white)', marginBottom: '16px', letterSpacing: '-0.02em' }}>Everything to Go from Zero to Open</h2>
          <p className="fu" style={{ color: 'var(--dim)', fontSize: '1rem', marginBottom: '56px', maxWidth: '520px' }}>Every deliverable is built by our team. You show up to the call with an idea. We hand you a business.</p>
            ...
            {checklistItems.map((item, i) => (
              <div key={i} className="fu svc-card" style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: '2px', padding: '28px 28px 28px 24px', display: 'flex', gap: '16px', alignItems: 'flex-start', position: 'relative', overflow: 'hidden', transition: 'border-color 0.2s, transform 0.2s' }}>
                ...
                <div style={{ flexShrink: 0, width: '28px', height: '28px', borderRadius: '50%', background: 'rgba(30,61,143,0.2)', border: '1px solid rgba(30,61,143,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2px' }}>
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2.5 7L5.5 10L11.5 4" stroke="var(--navy)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </div>
                <div>
        ...
        <section style={{ padding: 'clamp(60px, 8vw, 100px) clamp(20px, 6vw, 80px)', maxWidth: '1100px', margin: '0 auto' }}>
          <div className="fu" style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderLeft: '3px solid var(--navy)', padding: 'clamp(40px, 6vw, 64px) clamp(28px, 5vw, 56px)', borderRadius: '2px', maxWidth: '760px' }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.95rem', color: 'var(--dim)', marginTop: '24px', lineHeight: 1.7 }}>Startup Complete is for founders, side-hustlers, and first-time business owners who are ready to move fast.</p>
          </div>
        </section>
        <section style={{ padding: 'clamp(60px, 8vw, 100px) clamp(20px, 6vw, 80px)', maxWidth: '1100px', margin: '0 auto' }}>
          <div className="fu" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '32px', padding: 'clamp(48px, 7vw, 80px) clamp(28px, 5vw, 60px)', background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: '2px', position: 'relative', overflow: 'hidden' }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '1rem', color: 'var(--dim)', maxWidth: '480px', lineHeight: 1.7, position: 'relative', zIndex: 1 }}>Every deliverable listed above, delivered within 48 hours of your launch call. No hidden fees, no hourly billing, no scope creep.</p>
