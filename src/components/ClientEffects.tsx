...
export default function ClientEffects() {
  useEffect(() => {
    ...
    const createSpaceHum = (): SoundLayer => {
      ...
      return {
        fadeIn() {
          ...
          g1.gain.setTargetAtTime(0.045, t, 0.8);
          g2.gain.setTargetAtTime(0.025, t, 0.8);
          gn.gain.setTargetAtTime(0.02, t, 0.8);
        },
    ...
    const createNatureSound = (): SoundLayer => {
      const ctx2 = actx!;
      // 528Hz — the "miracle tone" for light mode ambient
      const o1 = ctx2.createOscillator(); o1.type = 'sine'; o1.frequency.value = 528;
      const g1 = ctx2.createGain(); g1.gain.value = 0; o1.connect(g1);
      // Harmonic overtone of 528Hz (1056Hz, soft)
      ...
      return {
        fadeIn() {
          const t = ctx2.currentTime;
          master.gain.setTargetAtTime(1, t, 0.5);
          g1.gain.setTargetAtTime(0.04, t, 0.8);
          g2.gain.setTargetAtTime(0.015, t, 0.8);
          gw.gain.setTargetAtTime(0.03, t, 0.8);
