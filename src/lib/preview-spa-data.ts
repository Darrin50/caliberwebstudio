...
const previewSpas: PreviewSpaEntry[] = [
  ...
  // ── Injector Lady Med Spa — Ann Arbor, MI · /preview/il4m7x2q ──────────────
  // Logo: Notion Leads DB Logo property (Injector Lady Logo.png) — downloaded 2026-04-28
  // Hero: universal-core U-HERO-02 (variation from Serenity which uses U-HERO-01)
  // Palette: rose/pink from logo lip mark (#D4698A) — distinct from Serenity teal (#4A8B7F)
  // Provider: Lynda Chiado, RN, RNFA — single-injector boutique, Ann Arbor
  {
    hash: 'il4m7x2q',
    config: {
      businessName: 'Injector Lady Med Spa',
      tagline: 'Precision. Passion. Perfection. — Ann Arbor, MI',
      location: 'Ann Arbor, MI',
      seoCity: 'Ann Arbor',
      phone: '(734) 250-9959',
      email: 'injectorlady@gmail.com',
      bookingUrl: undefined,
      logoHref: 'https://caliberwebstudio.com/detroit-med-spa-websites',
      heroHeadline: 'Precision. Passion. *Perfection.*',
      heroSub: '30+ years of nursing expertise meets the art of aesthetic medicine. Botox, fillers, skin rejuvenation, and medical weight loss — each treatment tailored to look and feel like you. Serving Ann Arbor, MI.',
      heroImg: '/mocks/injector-lady/injector-lady-hero-01.jpg',
      logoImg: '/mocks/injector-lady/injector-lady-logo.png',
      accentColor: '#D4698A',
      announceBar: 'Expert Nurse Injector &nbsp;·&nbsp; Ann Arbor, MI &nbsp;·&nbsp; Botox · Fillers · RF Microneedling · Medical Weight Loss &nbsp;·&nbsp; <span style="font-weight:700">(734) 250-9959</span>',
      providers: [
        {
          name: 'Lynda Chiado',
          title: 'Aesthetic Injector & Founder · The Injector Lady',
          credentials: 'RN, RNFA · Registered Nurse First Assistant · Fellowship Trained (Stanford & Johns Hopkins) · 30+ Years Clinical Nursing Experience · Michigan Licensed & Insured',
          philosophy: 'Each client brings a unique set of desires and definitions of beauty to the table. My role is to listen first — then apply precision technique to treatments that enhance your features while harmonizing with your natural anatomy. Precision, Passion, Perfection isn\'t a tagline. It\'s how I approach every appointment.',
        },
      ],
      servicePathways: [
        {
          category: 'Injectables',
          icon: '◇',
          treatments: ['Botox', 'Xeomin', 'Dermal Fillers', 'Kybella', 'PRP Hair Restoration'],
          description: 'Neuromodulators and dermal fillers for natural-looking rejuvenation, lip enhancement, and chin definition. Every injection placed personally by Lynda — no delegating.',
        },
        {
          category: 'Skin Rejuvenation',
          icon: '○',
          treatments: ['RF Microneedling', 'Microneedling', 'Chemical Peel', 'Dermaplaning'],
          description: 'Advanced treatments for texture, tone, and firmness — RF microneedling to chemical peels to dermaplaning. Customized to your skin\'s specific concerns.',
        },
        {
          category: 'Medical Weight Loss',
          icon: '⊕',
          treatments: ['Compounded Semaglutide', 'Tirzepatide', 'B-12 Injections', 'Red Carpet Skinny Shot', 'Ultimate Fat Blaster'],
          description: 'Clinically supervised weight management with GLP-1 medications and metabolic support. Medical-grade protocols tailored to your body and lifestyle.',
        },
        {
          category: 'Medical Skincare',
          icon: '◎',
          treatments: ['Medical Grade Skincare', 'Custom Regimen Builds', 'Skin Consultations', 'Clinical Product Guidance'],
          description: 'Prescription-strength skincare programs and clinical product guidance for every skin type. Evidence-based routines that actually work.',
        },
        {
          category: 'Lip & Facial',
          icon: '✦',
          treatments: ['Lip Augmentation', 'Cheek Enhancement', 'Jawline Contouring', 'Full-Face Balancing'],
          description: 'Artful facial balancing using fillers and neuromodulators — designed to enhance your natural features, not change them.',
        },
        {
          category: 'Membership',
          icon: '∿',
          treatments: ['Monthly Injectable Credits', 'Skin Treatment Plans', 'Priority Booking', 'Personalized Care Programs'],
          description: 'Consistent care delivers consistent results. A dedicated care plan with Lynda — accessible, personalized, and built around your goals.',
        },
      ],
      financing: [],
    },
